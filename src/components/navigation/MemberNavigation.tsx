...
const navigationItems = [
  { icon: Home, label: 'Home', path: '/member/dashboard/home' },
  { icon: Users, label: 'Network', path: '/member/dashboard/network' },
  { icon: DollarSign, label: 'Earnings', path: '/member/dashboard/earnings' },
