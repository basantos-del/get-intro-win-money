...
const NewHires = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        ...
        {/* Maria Photo Section */}
        <div className="mt-16 w-full animate-fade-in overflow-hidden">
          <img src="/lovable-uploads/de0437b6-8cfe-409f-804b-44ee5e67dae6.png" alt="Maria - Intro Member who knows people" className="w-full h-auto object-cover scale-95 -mb-8" style={{
          maxHeight: '600px'
        }} />
        </div>
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-center gap-6 max-w-4xl mx-auto">
          <Button onClick={handleJoinWaitlist} className="intro-button-cta text-lg px-8 py-4 flex-shrink-0">
            Join the Waitlist
          </Button>
