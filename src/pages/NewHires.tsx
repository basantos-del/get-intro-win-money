...
const NewHires = () => {
  ...
  React.useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Discover how intro helps businesses find new hires through referral recruiting. Connect with engaged members who can refer quality candidates.');
    }
    ...
    const structuredData = {
      ...
      "description": "Discover how intro helps businesses find new hires through referral recruiting.",
